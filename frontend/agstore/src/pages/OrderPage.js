...
const OrderPage = () => {
  ...
  const onPayWithJazzCash = async () => {
    try {
      ...
      showModal("Error", err?.data?.message || err.error || "Payment failed");
    }
  };
                    ...
                    <ListGroup.Item key={index}>
                      <Row className="align-items-center">
                        ...
                        <Col md={4} className="text-md-end">
                          {item.qty} x PKR {item.price} ={" "}
                          <strong>PKR {item.qty * item.price}</strong>
                        </Col>
                      </Row>
                    </ListGroup.Item>
                  ))}
                ...
                <ListGroup variant="flush">
                  ...
                  <ListGroup.Item>
                    <Row>
                      ...
                      <Col>
                        <strong>PKR {order.totalPrice}</strong>
                      </Col>
                    </Row>
                  </ListGroup.Item>
                        ...
                        <Card className="mt-3 bg-light">
                          <Card.Body>
                            <Card.Text className="small">
                              ...
                              <br />
                              <strong>Account:</strong> Muhammad Amin Lakhani
                              <br />
                              <strong>Number:</strong> 0323-2297316
                            </Card.Text>
                          </Card.Body>
                        </Card>
                      )}
