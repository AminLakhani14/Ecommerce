...
const ShippingPage = () => {
  ...
  const placeOrderHandler = async (e) => {
    ...
    try {
      ...
      showErrorModal(err.data?.message || err.error || "An unexpected error occurred.");
    }
  };
          ...
          <Form onSubmit={placeOrderHandler}>
            ...
            <div className={styles.formSection}>
              ...
              <Row className="mb-3">
                ...
                <Col>
                  <Form.Control value="Pakistan" readOnly disabled />
                </Col>
              </Row>
              <Form.Control
                type="tel"
            ...
            <Card.Body className="p-4">
              ...
              {cartItems.map((item) => (
                <Row key={item._id} className="mb-3 align-items-center">
                  <Col xs={3}>
                    <Image src={`${serverUrl}${item.image}`} thumbnail />
                  </Col>
                  <Col xs={6}>
                    <div>{item.name}</div>
